...
#
# Script generated by Vivado on Tue Nov 11 05:46:04 +0530 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : four_bit.sh
...
#
# Usage        : four_bit.sh
#                four_bit.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                four_bit.sh [-reset_run]
#                four_bit.sh [-reset_log]
#                four_bit.sh [-help]
#
...
# script info
echo -e "four_bit.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./four_bit.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot four_bit xil_defaultlib.four_bit xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim four_bit -key {Behavioral:sim_1:Functional:four_bit} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/AMDvivado/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb four_bit.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./four_bit.sh -help\" for more information)\n"
    exit 1
  fi
}
...
Usage: four_bit.sh [-step]\n\
Usage: four_bit.sh [-lib_map_path]\n\
Usage: four_bit.sh [-reset_run]\n\
Usage: four_bit.sh [-reset_log]\n\
Usage: four_bit.sh [-keep_index]\n\
Usage: four_bit.sh [-noclean_files]\n\n\
